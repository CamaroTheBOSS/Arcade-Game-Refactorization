...
class Menu:
    def __init__(self, window):
        ...
        self.options.textToRender = [
            self.font.render(f"Start game", True, (255, 255, 255)),
            self.font.render(f"Choose level from memory", True, (255, 255, 255)),
            self.font.render(f"Quit", True, (255, 255, 255))
        ]
        self.colors = [(0, 0, 0), (255, 255, 255), (255, 255, 255)]
        self.running = True
